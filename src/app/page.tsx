                        ...
                        <div className="max-w-6xl mx-auto px-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                                    ...
                                    <p className="text-gray-600">Ikkunoiden puhdistus on keskeinen osa kotisiivouksia. Tarjoamme nopeaa ja tehokasta puhdistusta, joka poistaa likaa ja huonekalujen kertynyttä likaa. Ikkunoiden siivous on helpointa luottaa ammattilaisille – pyydä tarjous ja vakuuttaudu puhtauden palautumisesta tänään!</p>                                </div>
